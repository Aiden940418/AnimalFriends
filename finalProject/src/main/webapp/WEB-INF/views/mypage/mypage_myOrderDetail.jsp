...
<style>
	...
	<div class="contentDiv">
		...
		<!-- 구매내역 박스 -->
		       	...
		       	<div class="container mt-5 text-center ms-5" style="width:1000px;">
           <div class="row g-0" style="border:solid 1px;">
					...
					<img src="resources/${orderView.gImg}" style="width:300px;">
						<h5 class="card-title">주문번호 : ${orderView.orderId } </h5><br>
						...
						<a type="button" id="reviewOpen_btn2" href="goodsDetails.do?gNo=${orderView.gNo }#review">작성한 리뷰보러가기 </a>
