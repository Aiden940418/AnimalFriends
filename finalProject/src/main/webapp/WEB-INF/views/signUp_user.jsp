	...
	<form action="">			
                ...
                <div>
                    ...
                    <span class="box int_pass">
                        <input type="text" id="pswd1"  class="int" maxlength="20" name="mPw">
                ...
                <div>
                    ...
                    <span class="box int_name">
                        <input type="text" id="name" class="int" maxlength="20" name="iName">
                    </span>
                    <span class="error_next_box"></span>
                </div>
                ...
                <div>
                    ...
                    <span class="box int_nickname">
                        <input type="text" id="nickname" class="int" maxlength="20" name="iNick">
                    </span>
                    <span class="error_next_box"></span>
                </div>
                ...
                <div>
                    ...
                    <span class="box int_mobile">
                        <input type="tel" id="iPhone" class="int" maxlength="16" placeholder="전화번호 입력"
                        name="iPhone">
                    </span>
                    <span class="error_next_box"></span>    
                </div>
