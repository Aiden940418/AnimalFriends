...
<div class="contentDiv">
	...
	<button type="button" class="btn btn-outline-success mt-3 float-end" onclick="location.href='adminAdopt.do'">목록보기</button>
		...
		<br>
			<div class="wrap">
  		<a href="chattingList.do" class="button" id="chat">1:1채팅 요청</a>
  		</div>
