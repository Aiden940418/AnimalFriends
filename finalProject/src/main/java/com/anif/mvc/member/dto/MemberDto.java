...
public class MemberDto {
	...
	public MemberDto(int mNo, String mRole, String mJoinYn, String mId, String mPw, String mEmail, String mAddr1,
			String mAddr2, String mAddr3, String mName, String mNick, String mPhone, String sBisNum, String sSellNum) {
		super();
		this.mNo = mNo;
		this.mRole = mRole;
	...
	public String toString() {
		return "MemberDto [mNo=" + mNo + ", mRole=" + mRole + ", mJoinYn=" + mJoinYn + ", mId=" + mId + ", mPw=" + mPw
				+ ", mEmail=" + mEmail + ", mAddr1=" + mAddr1 + ", mAddr2=" + mAddr2 + ", mAddr3=" + mAddr3 + ", mName="
				+ mName + ", mNick=" + mNick + ", mPhone=" + mPhone + ", sBisNum=" + sBisNum + ", sSellNum=" + sSellNum
				+ "]";
	}
